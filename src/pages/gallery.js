...
const GalleryPage = () => (
    <Layout>        
        ...
        <a target="_blank" href="../images/dj_harrelson_phillips.jpg">
            <img src="../images/dj_harrelson_phillips.jpg" alt="Dj, Woody, Rep. Phillips" width="600" height="400" />
        </a>
        ...
        <a target="_blank" href="../images/gc_2021.jpg">
            <img src="../images/gc_2021.jpg" alt="Brothers at the 83rd Grand Chapter in Phoenix" width="600" height="400" />
        </a>
        <div class="desc">Brothers at the 83rd Grand Chapter in Phoenix</div>
        </div>
        <div class="gallery">
        <a target="_blank" href="../images/province_2020.jpg">
            <img src="../images/province_2020.jpg" alt="Brothers after the 2020 North Central Province Conference" width="600" height="400" />
        </a>
