...
const BylawsPage = () => (
  <Layout>
    ...
    <div>
        ...
        <br/>
        <h2 id="preamble" class="center">PREAMBLE<a href="#preamble" class="link"></a></h2>
        <p>Believing that where there is law there is liberty, we the members of the <strong>Greater Minnesota</strong> Alumni
           Chapter of the Sigma Chi Fraternity do hereby establish and solemnly promise to obey these bylaws to supplement and support the
           Ritual, Constitution, Statutes and Executive Committee Regulations of the Sigma Chi Fraternity for the government of
           our organization.
        </p>

        <br/><hr/>
        <h2 id="article1" class="center">ARTICLE I: NAME AND PURPOSE<a href="#article1" class="link"></a></h2>
        ...
        <br/><hr/>
        <h2 id="article2" class="center">ARTICLE II MEMBERSHIP<a href="#article2" class="link"></a></h2>
        ...
        <ol type="A">
            ...
            <li>A new member, expressing interest in membership by attending an event after January 1 of the current fiscal
                year, shall be eligible to gain full membership status during the current fiscal year by paying his dues within 30
                days to the treasurer.
            </li>
        </ol>
        ...
        <br/><hr/>
        <h2 id="article3" class="center">ARTICLE III MEETINGS & ELECTIONS<a href="#article3" class="link"></a></h2>
        ...
        <ol type="A">
            ...
            <ul>
                <li>In the event that more than two candidates are nominated for the same position, a plurality is sufficient for election.</li>
            </ul>
        ...
        <ol type="A">
            ...
            <li>Voting shall be by acclamation and a majority vote of the active alumni organization members present shall decide
        ...
        <br/><hr/>
        <h2 id="article4" class="center">ARTICLE IV OFFICERS<a href="#article4" class="link"></a></h2>
        ...
        <ol type="A">
            <li>The communications officer shall coordinate the publication of the alumni organization newsletter and other
                publications, including occasional directories or special meeting notices. He shall also submit news of organization
        ...
        <ol type="A">
            <li>The social and brotherhood officer shall organize events of different character to build the bonds of brotherhood
                and encourage participation of members within the area.
            </li>
            <li>The social and brotherhood officer shall direct the Membership and Recruitment Committee in recruiting new members.</li>
        ...
        <ol type="A">
            ...
            <li>The undergraduate liaison shall be the current Grand Praetor of the North Central Province. Should the Grand
                ...
                to elect his assistant or the organization advisor of an undergraduate organization in good standing by acclamation.</li>
        ...
        <ol type="A">
            ...
            <li>Should the officer position be needed for more than the fiscal year, an amendment to the bylaws shall be made.</li>
        </ol>

        <h3 id="a4s10">Section 10 Term of Office</h3>
        <ol type="A">
            <li>The term of office for officers, both appointed and elected, shall be for one year beginning the first of <strong>July</strong> following their election and appointment.</li>
        </ol>

        <h3 id="a4s11">Section 11 Impeachment<a href="#a4s11" class="link"></a></h3>
        <ol type="A">
            <li>Any officer of this alumni organization may be impeached for non-exemplary conduct or conduct unbecoming of a Sigma Chi.</li>
            <li>A two-thirds vote of the alumni organization shall impeach any officer, provided charges have been openly
                ...
                impeachment vote is to be taken.
            </li>
        ...
        <ol type="A">
            <li>All vacancies in the executive committee or any office in the alumni organization, from any cause, other than
                the expiration of the term of office, shall follow the rules set forth in Article III, Section 4 Special Elections.
            </li>
        </ol>
        <div class="center">
            <a href="#article4">To top of article</a> | <a href="#top">To Top</a>
        </div>
        ...
        <ol type="A">
            ...
            <li>The executive committee shall meet at least <strong>every two months</strong> for the purpose of assisting in
                the planning and fulfillment of a well-rounded active alumni organization program.
            </li>
        ...
        <ol type="A">
            ...
            <li>This committee shall secure the names, postal addresses, e-mall addresses, and phone numbers of all members of the alumni organization.</li>
            <li>This committee will endeavor to encourage active participation of all Sigma Chi alumni members living in the immediate area.</li>
        ...
        <ol type="A">
            <li>The chairman of the Events Committee shall be the <strong>social and brotherhood officer</strong> with the
                officers or designees as event coordinators who will oversee the planning and execution of all events hosted by the alumni
                organization, including, but not limited to, social activities, service projects and philanthropic efforts.
            </li>
        ...
        <div class="center">
            <a href="#article5">To top of article</a> | <a href="#top">To Top</a>
        </div>

        <br/><hr/>
        <h2 id="article6" class="center">ARTICLE VI AMENDMENTS<a href="#article6" class="link"></a></h2>
        ...
        <br/><hr/>
        <h2 id="article7" class="center">ARTICLE VII EVENTS AND EVENT COORDINATORS</h2>
        ...
        <div class="center">
            <a href="#article7">To top of article</a> | <a href="#top">To Top</a>
        </div>
    </div>
  </Layout>
)
